...
def parse_flags():
  ...
  all_modes_group.add_argument(
      '--sample_rate', type=int, choices=[44100, 32000, 16000], default='44', required=True,
      help='Resample data into 32kHz, 16kHz or use its input sample rate which is 44kHz.')
  all_modes_group.add_argument(
